...
import type { UserController } from '@/modules/users/controllers/user.controller.js';
import {
  createUserRequestDto,
  retrieveUserRequestDto,
  updateMeRequestDto,
  updateUserRequestDto
} from '@/modules/users/dtos/user.dto.js';

export const createUserRouter = (userController: UserController, authenticate: RequestHandler): Router => {
  const router = Router();
  ...
  router.post(
    ...
    validateRequest(createUserRequestDto),
